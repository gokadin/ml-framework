...
func (od *opDot) forward(tensor *Tensor) {
	tensor.mat = mat.MatMul(od.a.mat, od.b.mat)
...
func (od *opDot) backward(tensor *Tensor) {
	if od.a.isGradientEnabled {
		od.a.grad = mat.MatMul(tensor.grad, mat.Transpose(od.b.mat))
	}
	if od.b.isGradientEnabled {
		od.b.grad = mat.Transpose(mat.MatMul(mat.Transpose(tensor.grad), od.a.mat))
	}
}
