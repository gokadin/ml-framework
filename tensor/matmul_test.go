...
func buildMatmulTestCases() []matmulTestCases {
	return []matmulTestCases{
		...
		{"4x6 and 6x4 GPU", From(mat.InitRandom, 4, 6), From(mat.InitRandom, 6, 4), true},
		{"4x6 and 6x4 CPU", From(mat.InitRandom, 4, 6), From(mat.InitRandom, 6, 4), false},
		{"4x6 and 6x3 GPU", From(mat.InitRandom, 4, 6), From(mat.InitRandom, 6, 3), true},
		{"4x6 and 6x3 CPU", From(mat.InitRandom, 4, 6), From(mat.InitRandom, 6, 3), false},
		{"1000x784 and 784x128 GPU", From(mat.InitRandom, 1000, 784), From(mat.InitRandom, 784, 128), true},
		{"1000x784 and 784x128 CPU", From(mat.InitRandom, 1000, 784), From(mat.InitRandom, 784, 128), false},
	}
}
